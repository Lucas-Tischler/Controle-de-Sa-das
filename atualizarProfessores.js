...
id.addEventListener("change", (e) => {
    ...
    if (idValue !== "") {
        ...
        fetch(`http://localhost:8081/professor/${idValue}`)
            .then((res) => {
            ...
            .catch((err) => {
                console.error(err);
                res.innerHTML = `<p style="color:red;">Erro ao buscar aluno: ${err.message}</p>`;
            });
    }
});
